...
// Byte size pattern: number followed by byte unit (e.g., 10KB, 1.5MB)
ByteSize : Number Space* BYTE_UNIT;

// Time duration pattern: number followed by time unit (e.g., 10ms, 1.5s)
TimeDuration : Number Space* TIME_UNIT;
