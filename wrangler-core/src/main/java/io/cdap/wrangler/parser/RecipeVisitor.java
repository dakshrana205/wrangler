 ...
 */
 ...
 public final class RecipeVisitor extends DirectivesBaseVisitor<RecipeSymbol.Builder> {
   ...
   /**
    * Visits a byte size argument and creates a ByteSize token.
    */
   @Override
   ...
   /**
    * Visits a time duration argument and creates a TimeDuration token.
    */
   @Override
   ...
   private SourceInfo getOriginalSource(ParserRuleContext ctx) {
     return new SourceInfo(ctx.getStart().getLine(), ctx.getStart().getCharPositionInLine(),
                          ctx.getStop().getLine(), ctx.getStop().getCharPositionInLine(),
                          ctx.getStart().getInputStream().getText(new Interval(ctx.getStart().getStartIndex(),
